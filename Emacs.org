...
#+begin_src emacs-lisp
  ...
  ;; Add Homebrew directory to exec-path
  (add-to-list 'exec-path "/opt/homebrew/bin")  ; Use "" for Apple Silicon
  ;; Update PATH environment variable
  (setenv "PATH" (concat "/opt/homebrew/bin:" (getenv "PATH")))  ; Use "" for Apple Silicon
