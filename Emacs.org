...
#+begin_src emacs-lisp
  ...
  (use-package diff-hl
    ...
    (:repeat-map diff-hl-command-map 
                 ...
                 ("j" . diff-hl-show-hunk-next)
                 ("p" . diff-hl-show-hunk-previous) 
                 ("k" . diff-hl-show-hunk-previous) 
    ...
    :config
    (general-nvmap
      "gc;" 'diff-hl-show-hunk-next
      "gc," 'diff-hl-show-hunk-previous
      "gcj" 'diff-hl-show-hunk-next
      "gck" 'diff-hl-show-hunk-previous)
...
#+begin_src emacs-lisp
  ...
  (use-package evil
    ...
    (setq evil-ex-search-case "insensitive"
          ...
          select-enable-clipboard t  ;; Sync with the system clipboard
          evil-want-register-synchronization t)  ;; Synchronize registers
